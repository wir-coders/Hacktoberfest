# Contribution to Introduction / Making your first Pull Request
...
GitHub repository URLs will reference both the username associated with the owner of the repository, as well as the repository name. For example, Hacker is the owner of the Hacktoberfest repository, so the GitHub URL for this project is:
...
After cloning the repo, create a file inside the folder `Python` -
  - Add a file of `filename.py`.
  - Edit the file.
  - Save changes.

Whoohoo! you are one step away from contributing to open source.
